...
EMPTY, TREE, SETTLE, WATER_STATION, FIRE, SETTLE_FIRE, BURNT, SETTLE_BURNT, WET_TREE, WET_SETTLE, FIRE_BREAK = VALUES
COLORS = ['white', 'forestgreen', 'purple', 'aqua', 'red', 'firebrick', 'black', 'saddlebrown', 'cornflowerblue', 'royalblue', 'royalblue']
